...
function Footer() {
  return (
    <footer class="bg-white py-6 px-10 font-sans tracking-wide">
    <div class="flex items-center justify-between max-sm:flex-col gap-5">
      <p class="text-lg text-blue-800">Follow us</p>
      <ul class="flex flex-wrap justify-center gap-x-8 gap-4">
        <li>
          <a href="javascript:void(0)" class="text-xl hover:text-blue-400">
