...
function Header() {
  ...
  <a href="javascript:void(0)">  <span class="font-bold">MOHA</span>
  </a>
      ...
      <div id="collapseMenu"
        ...
        <Link to='/App' className='hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]'>Home</Link>
      </li>
      <li className='max-lg:border-b max-lg:py-3 px-3'>
        <Link to='/about' className='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>About</Link>
      </li>
